    ...
    public void connect() {
        ...
        for (int i = 0; i < retries; ++i) {
            ...
            try {
                ...
                Thread.sleep(1000);
                // Connect to database
                // this may need to be changed back to db:3306 instead of localhost:33060 !!! - changed back to db:3306 for github actions - changed back to localhost again just to see
...
//The population of people, people living in cities, and people not living in cities in each country.
    ...
    public static void main(String[] args) {
        ...
        if (a.con != null) {
            ...
            System.out.println("\nRunning The top N populated cities in a country where N is provided by the user.\n");
            a.top_pop_country_user_input(3);
            System.out.println("\nRunning The top N populated cities in a district where N is provided by the user.\n");
            a.top_pop_district_user_input(3);
            System.out.println("\nRunning All the capital cities in the world organised by largest population to smallest.\n");
            a.all_capital_world();
            System.out.println("\nRunning All the capital cities in a continent organised by largest population to smallest.\n");
            a.all_capital_world_by_continent();
            System.out.println("\nRunning All the capital cities in a continent organised by largest population to smallest.\n");
            a.all_capital_world_by_region();
            System.out.println("\nRunning The top N populated capital cities in the world where N is provided by the user.\n");
            a.all_capital_world_user_input(5);
            System.out.println("\nRunning The top N populated capital cities in a continent where N is provided by the user.\n");
            a.all_capital_world_by_continent_user_input(4);
            System.out.println("\nRunning he top N populated capital cities in a region where N is provided by the user.\n");
